...
/* USER CODE BEGIN PTD */
/*
./openocd.exe -f ../share/openocd/scripts/interface/stlink.cfg -f ../share/openocd/scripts/board/stm32f429discovery.cfg
*/
/* USER CODE END PTD */
...
GlobalType_t SystemClock_Config(void);
...
int main(void)
{
  ...
  while (1)
  {
    ...
    {  
        loop_tick = HAL_GetTick();
        PRINT_LOG(LOG_INFO, loop_tick, "hello world!");
        LED_TOGGLE;       
    }
    /* USER CODE BEGIN 3 */
  }
