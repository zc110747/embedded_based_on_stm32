...
{  
    ...
    flash_parameter_init();
    
    flash_parameter_write_with_compare();
    p_parameter->baudrate = 115200;
    
    // write and update
    flash_parameter_write_with_compare();
    flash_parameter_update();
    
    PRINT_LOG(LOG_INFO, HAL_GetTick(), "flash parameter baudrate:%d", p_parameter->baudrate);
